        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              ...
              to homes and to the business sociaty BEST WAY FURNITURES was form, BEST WAY FURNITURES is a legal infrastructure with professional enivoroment 
          ...
          <div class="col-md-6">
            ...
            <div class="collapse" id="collapseFour" aria-labelledby="headingfour" data-parent="#accordion">
              <div class="img_container ">
                <div class="box b-1">
                  <div class="img-box">
                    <img src="images/Dinning 2.jpg" alt="">
                  </div>

                  <div class="img-box">
                    <img src="images/Dinning1.jpg" alt="">
                  </div>
                </div>
                <div class="box b-2">
                  <div class="img-box">
                    <img src="images/Dinning3.jpg" alt="">
                  </div>
                  <div class="img-box">
                    <img src="images/Dinning 4.jpg" alt="">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <form action="" method="post">
            ...
            <div class="d-flex ">
              <button name="submit_info" type="submit">
                SEND
              </button>
            </div>
          </form>
        ...
        <div class="col-md-3">
          <div class="info_contact">
            ...
            <div>
              ...
              <p>
                No 6, daniel plaza alaba international
              </p>
            </div>
            <div>
              <div class="img-box">
